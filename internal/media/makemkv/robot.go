...
func BuildTitleView(title TitleInfo) (TitleView, error) {
	...
	subtitleTracks := filterForcedSubtitles(collectTracksByType(title.Tracks, "Subtitles"))
...
func filterForcedSubtitles(tracks []TrackInfo) []TrackInfo {
...
func audioCodecLabel(track TrackInfo) string {
	label := NormalizeAudioCodecLabel(track.CodecShort, track.ChannelLayout)
