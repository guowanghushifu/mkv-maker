...
export const messages: Record<Locale, MessageSet> = {
  zh: {
    ...
    scan: {
      title: '扫描片源',
      subtitle: '支持已解压的 BDMV 目录和 ISO 文件作为工作流输入。',
      scanButton: '扫描片源',
      scanningButton: '扫描中...',
      nextButton: '下一步',
      empty: '暂无片源，请先扫描 BDMV 目录或 ISO 文件。',
      columns: {
        select: '选择',
        name: '名称',
        type: '类型',
    ...
    editor: {
      ...
      audioHeading: '音频',
      subtitlesHeading: '字幕',
      recommendButton: '猜你喜欢',
      recommendAudio: '猜你喜欢音频',
      recommendSubtitles: '猜你喜欢字幕',
  ...
  en: {
    ...
    scan: {
      title: 'Scan Sources',
      subtitle: 'Extracted BDMV folders and ISO files are accepted as workflow input.',
    ...
    editor: {
      ...
      recommendButton: 'Recommended',
      recommendAudio: 'Recommend audio tracks',
      recommendSubtitles: 'Recommend subtitle tracks',
